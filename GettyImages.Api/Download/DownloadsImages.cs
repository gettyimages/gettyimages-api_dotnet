...
namespace GettyImages.Api.Download
{
    public class DownloadsImages : ApiRequest
    {
        ...
        private DownloadsImages(Credentials credentials, string baseUrl, DelegatingHandler customHandler) : base(customHandler)
        {
        ...
        internal static DownloadsImages GetInstance(Credentials credentials, string baseUrl, DelegatingHandler customHandler)
        {
